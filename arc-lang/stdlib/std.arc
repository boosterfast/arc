...
extern def infix ==[T](T, T): bool;

@{rust: "i32::ge", mlir: "geq_i32"}
extern def infix >=(i32, i32): bool;
...
extern def infix bor(i32, i32): bool;

@{rust: "i32::xor", mlir: "xor_i32"}
extern def infix bxor(i32, i32): bool;

@{rust: "i32::and", mlir: "and_i32"}
extern def infix band(i32, i32): bool;
...
# extern def infix +::[u32](u32, u32): u32;
#
...
# extern def infix ==::[u32](u32, u32): bool;
#
...
# extern def infix negu32(u32): u32;
...
# extern def infix +::[f32](f32, f32): f32;
#
...
# extern def infix ==::[f32](f32, f32): bool;
#
...
# extern def infix neg::[f32](f32): f32;
...
extern def infix and(bool, bool): bool;

@{rust: "or", mlir: "or_i1"}
extern def infix or(bool, bool): bool;

@{rust: "xor", mlir: "xor_i1"}
extern def infix xor(bool, bool): bool;
...
@{rust: "Set::new"}
extern def new_set[T](): Set[T];

@{rust: "Set::insert"}
extern def add_elem[T](Set[T], T);

@{rust: "Set::remove"}
extern def del_elem[T](Set[T], T);

@{rust: "Set::contains"}
extern def contains[T](Set[T], T): bool;
